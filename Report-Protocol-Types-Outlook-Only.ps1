...
#Name: RPCA: Basic query Sam 002
#Log Type: EXCHANGE_EXTENSIBLE
#Generated: 1/24/2020 10:50:55 PM
...
$Destination = "RPCA- Basic query Sam 002.CSV"
...
$SQLQuery = "SELECT protocol, MUL(PROPCOUNT(*), 100.0) as [Percent]  INTO '" + $Destination + "' FROM  '%ExchangeInstallPath%\Logging\RPC Client Access\*.LOG' WHERE Operation LIKE 'Connect' AND client-software LIKE '%OUTLOOK%' AND client-software NOT LIKE '%.Exchange.%' GROUP BY protocol "
